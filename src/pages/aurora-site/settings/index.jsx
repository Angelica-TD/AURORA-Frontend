      ...
      items: [
        {
          ...
          control: (
            <select
              className="mt-1 block w-48 pl-3 pr-10 py-2 text-base border bg-blue-700 text-white border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
              value={language}
